...
public class LoginActivity extends Activity {
	...
	// findViewById(R.id.login_btn_submit).setOnClickListener(new
	// OnClickListener() {
	//
	// @Override
...
//
//// UserDao.login(editPhone.getText().toString(),
// editPassword.getText().toString(), new LogInCallback<AVUser>() {
//// @Override
//// public void done(AVUser avUser, AVException arg1) {
//// if( avUser == null){
//// Toast.makeText(LoginActivity.this, "登录失败"+arg1.getMessage(), 1000 *
// 5).show();
//// return;
//// }
//// User user = User.parseToMyUser(avUser);
//// Toast.makeText(LoginActivity.this, "登录成功"+user.getUsername(), 1000 *
// 5).show();
//// //保存用户信息
